...
let ar1 = ['Kate', '17', true, '221', 'Cat', false]; // переменную обьявляем здесь!!!!
...
let ar2 = ['Car', false, '13', true, 'Pen'] // переменную обьявляем здесь!!!!
...
let ar3 = ['Name', '457', 'ID', '2']  // переменную обьявляем здесь!!!!
...
let ar4 = [1, 6, 9, 3, 2, 9, 7, 1, 4, 8, 2]  // переменную обьявляем эту здесь!!!!

function f4() {
    out4.innerHTML = '';
    out4.innerHTML += ar4[0] + ' ';
    out4.innerHTML += ar4[3] + ' ';
    out4.innerHTML += ar4[8];
}
...
function f16() {
    ...
    for (let i = 0; i < ar16.length; i++) {
        if (ar16_even[i] !== undefined) {
            out16even.innerHTML += ar16_even[i] + ' ';
        }
        else if (ar16_odd[i] !== undefined) {
